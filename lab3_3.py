...
def hedge(x, y, size):
    ellipse(screen, (64, 62, 57), (x, y, 210 * size, 100 * size))
    ellipse(screen, (64, 62, 57), (x + 160 * size, y + 80 * size, 30 * size, 20 * size))
    ellipse(screen, (64, 62, 57), (x + 180 * size, y + 65 * size, 30 * size, 20 * size))
    ellipse(screen, (64, 62, 57), (x - 10 * size, y + 65 * size, 30 * size, 20 * size))
    ellipse(screen, (64, 62, 57), (x + 10 * size, y + 80 * size, 30 * size, 20 * size))
    ...
    ellipse(screen, (64, 62, 57), (x + 185 * size, y + 35 * size, 80 * size, 40 * size))
